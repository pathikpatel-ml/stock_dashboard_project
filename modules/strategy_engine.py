...
def quality_filter(df_shortlist, current_year, df=None):
    ...
    filtered["passes_book_value_growth"] = filtered["10yr_avg_book_value_growth"] > 10
    filtered["passes_eps_growth"] = filtered["10yr_avg_eps_growth"] > 10
    filtered["passes_roce"] = filtered["10yr_avg_roce"] > 10
    filtered["passes_sales_growth"] = filtered["10yr_avg_sales_growth"] > 10
